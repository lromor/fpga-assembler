...
class BitstreamWriter {
 ...
 public:
  ...
  int writeBitstream(const typename ArchType::ConfigurationPackage &packets,
                     ...
                     const std::string &generator_name, std::ostream &out);
  iterator begin();
  iterator end();
...
template <Architecture Arch>
int BitstreamWriter<Arch>::writeBitstream(const ConfigurationPackage &packets,
                                          const std::string &part_name,
                                          const std::string &source_name,
                                          const std::string &generator_name,
                                          std::ostream &out) {
...
BitstreamWriter<Arch>::create_header(const std::string &part_name,
  ...
  auto build_source = absl::StrCat(source_name, ";Generator=" + generator_name);
